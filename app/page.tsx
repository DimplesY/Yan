...
export default function Page() {
  return (
    <div className="container mx-auto text-foreground">
      <nav className='w-full mx-auto h-15 rounded-full sticky top-5 z-10 backdrop-blur-2xl shadow font-geist-sans flex items-center px-10'>
        <Link href="/" className='font-bold text-2xl'>DimplesY</Link>
      </nav>

      <div className="prose prose-invert lg:prose-lg prose-p:my-2 px-3 prose-h2:mt-4 prose-img:my-2 py-50 mx-auto font-geist-mono flex flex-col slide-enter-content">
