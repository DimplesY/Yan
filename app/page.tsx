...
export default function Page() {
  return (
    <div className="container prose lg:prose-lg prose-p:my-2 px-3 prose-h2:mt-4 prose-img:my-2 py-50 mx-auto font-geist-mono flex flex-col slide-enter-content">
